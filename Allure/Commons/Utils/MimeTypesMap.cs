...
//Copyright - https://github.com/hey-red/MimeTypesMap
namespace Allure.Commons.Utils
{
    ...
    public static class MimeTypesMap
    {
        ...
        public static string GetMimeType(string fileName)
        {
            ...
            if (ind != -1 && ext.Length > ind + 1) ext = fileName.Substring(ind + 1);
            if (_mimeTypeMap.Value.TryGetValue(ext, out var result)) return result;
